    ...
    <section className="py-24 border-b border-border/30">
      <div className="container max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 space-y-4">
          ...
          {/* Important Note for specific sections */}
          {theme.note && (
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 pt-32 pb-16">
        <div className="container max-w-7xl mx-auto px-6 text-center max-w-3xl">
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <div className="relative z-10 py-24">
        <div className="container max-w-5xl mx-auto px-6 text-center">
          <div className="p-12 md:p-20 rounded-[3rem] bg-gradient-to-br from-primary/20 to-accent/10 border border-primary/20 relative overflow-hidden">
