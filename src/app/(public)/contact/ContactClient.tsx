...
export default function ContactClient() {
  ...
  return (
    <div className="container mx-auto px-6 py-24 max-w-3xl">
      ...
      <div className="bg-card border border-border/40 p-8 rounded-2xl shadow-xl overflow-hidden relative">
                  ...
                  <AnimatePresence>
                    {dropdownOpen && (
                      <motion.div 
                        ...
                        exit={{ opacity: 0, y: -5 }}
                        className="absolute top-[72px] left-0 w-full z-10 bg-card border border-border/40 rounded-xl shadow-xl max-h-64 overflow-y-auto p-2"
                      >
                        {[
