...
export function OfferPopup() {
  ...
  useEffect(() => {
    ...
    // Only show on homepage or services pages
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-lg bg-card/95 backdrop-blur-xl border border-border/50 rounded-3xl p-8 shadow-2xl overflow-hidden"
          >
            {/* Background Effects */}
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <h2 className="font-heading text-3xl font-bold mb-3 flex items-center justify-center gap-2 text-foreground">
                Accelerate Your Growth <Sparkles className="w-6 h-6 text-accent animate-pulse" />
              </h2>
              ...
              <div className="flex flex-col w-full gap-3">
                <Link
                  href="/contact"
                  onClick={() => setIsOpen(false)}
                  className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-white font-bold py-4 rounded-xl transition-all shadow-[0_0_20px_rgba(var(--primary),0.3)] hover:shadow-[0_0_30px_rgba(var(--primary),0.5)] hover:-translate-y-1"
                >
